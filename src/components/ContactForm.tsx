  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6">
      <motion.form
        ...
        className="bg-gray-800 shadow-2xl rounded-3xl p-8 max-w-lg w-full"
      >
        ...
        <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }} className="mb-4">
          ...
          <input
            ...
            className="w-full bg-gray-800 p-3 border border-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
        ...
        <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }} className="mb-4">
          ...
          <textarea
            ...
            className="w-full bg-gray-800 p-3 border border-gray-100 rounded-lg h-32 resize-none focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
        ...
        <motion.button
          ...
          className={`w-full py-3 rounded-lg font-medium text-white transition duration-300 flex items-center justify-center gap-2
            ${formik.isSubmitting ? "bg-purple-400 cursor-not-allowed" : "bg-purple-600 hover:bg-purple-700"}
          `}
